...
const isDev = process.env.npm_lifecycle_event === 'build:debug' || process.env.NODE_ENV === 'development'
                ...
                async writeBundle(options, bundle) {
                    ...
                    try {
                        ...
                        for (const file of files) {
                            ...
                            const needsEmbed = !map.sourcesContent || map.sourcesContent.every(s => s === null || s === undefined);
                            ...
                            content = content.replace(regex, `//# sourceMappingURL=data:application/json;base64,${newBase}`);
