...
<template>
  <div v-if="platform !== 'macos'" class="mb-4">
    <label for="adapter_name" class="block text-sm font-medium mb-1 text-solar-dark dark:text-lunar-light">{{
      $t('config.adapter_name') }}</label>
    <input id="adapter_name" v-model="config.adapter_name" type="text"
