...
static struct pixel_argb_u16 argb_u16_from_xrgb2101010(const __le32 *pixel)
{
	u32 value = le32_to_cpu(*pixel);

	return argb_u16_from_u16161616(
		0xffff,
		DIV_ROUND_CLOSEST(((value >> 20) & 0x3ff) * 65535U, 1023),
		DIV_ROUND_CLOSEST(((value >> 10) & 0x3ff) * 65535U, 1023),
		DIV_ROUND_CLOSEST((value & 0x3ff) * 65535U, 1023));
}

static struct pixel_argb_u16 argb_u16_from_xbgr2101010(const __le32 *pixel)
{
	struct pixel_argb_u16 value = argb_u16_from_xrgb2101010(pixel);

	swap(value.r, value.b);
	return value;
}

static struct pixel_argb_u16 argb_u16_from_argb2101010(const __le32 *pixel)
{
	u32 raw = le32_to_cpu(*pixel);
	struct pixel_argb_u16 value = argb_u16_from_xrgb2101010(pixel);

	value.a = DIV_ROUND_CLOSEST(((raw >> 30) & 0x3) * 65535U, 3);
	return value;
}

static struct pixel_argb_u16 argb_u16_from_abgr2101010(const __le32 *pixel)
{
	struct pixel_argb_u16 value = argb_u16_from_argb2101010(pixel);
...
READ_LINE(XRGB2101010_read_line, px, __le32, argb_u16_from_xrgb2101010, px)
READ_LINE(XBGR2101010_read_line, px, __le32, argb_u16_from_xbgr2101010, px)
READ_LINE(ARGB2101010_read_line, px, __le32, argb_u16_from_argb2101010, px)
READ_LINE(ABGR2101010_read_line, px, __le32, argb_u16_from_abgr2101010, px)
...
pixel_read_line_t get_pixel_read_line_function(u32 format)
{
	...
	case DRM_FORMAT_XRGB2101010:
		return &XRGB2101010_read_line;
	case DRM_FORMAT_XBGR2101010:
		return &XBGR2101010_read_line;
	case DRM_FORMAT_ARGB2101010:
		return &ARGB2101010_read_line;
	case DRM_FORMAT_ABGR2101010:
		return &ABGR2101010_read_line;
