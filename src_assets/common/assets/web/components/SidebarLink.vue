...
const hoverClasses =
  'hover:text-solar-dark dark:hover:text-lunar-light hover:bg-solar-primary/10 dark:hover:bg-lunar-primary/10';
const activeClasses =
  'bg-solar-primary/15 dark:bg-lunar-primary/15 text-solar-dark dark:text-lunar-light font-medium';
</script>
<style scoped></style>
