    ...
    <div
      ...
      <div class="p-6 space-y-6 text-xs overflow-y-auto max-h-[70vh]">
          ...
          <div class="space-y-1 col-span-2 flex flex-col">
            ...
            <div class="flex items-start gap-3">
              ...
              <div
                ...
                <div v-else class="text-2xl font-bold text-solar-primary/40 dark:text-lunar-primary/40">
        ...
        <div>
          <div class="flex items-center justify-between mb-2">
            ...
            <button class="mini-btn" @click="addPrep">
      ...
      <div class="flex items-center justify-between px-6 py-4 border-t border-black/5 dark:border-white/10 gap-3">
        <div class="flex gap-2">
          ...
          <button class="ghost-btn" @click="close">
            Cancel
          </button>
        </div>
...
.app-input:focus {
  outline: 2px solid rgba(253, 184, 19, .5);
}
