<template>
  <div id="content">
    ...
    <div
      ...
      v-if="fancyLogs.find((x) => x.level === 'Fatal')"
    >
      <div style="line-height: 32px">
        <font-awesome-icon
          icon="circle-exclamation"
          style="font-size: 32px; margin-right: 0.25em"
        />
      ...
      <ul>
        <li
          v-for="v in fancyLogs.filter((x) => x.level === 'Fatal')"
          :key="v.timestamp + v.value"
        >
          {{ v.value }}
        </li>
      </ul>
      <router-link class="btn btn-danger" to="/troubleshooting#logs"
    ...
    <div class="card p-2 my-4">
      <div class="card-body" v-if="version">
        ...
        <div v-if="stableBuildAvailable" class="alert alert-warning">
          <div class="d-flex justify-content-between">
            <div class="my-2">
