...
elseif(UNIX)
    ...
    if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
        ...
        if(BUILD_VIBESHINE_KWIN_GPU_BRIDGE)
            set(VIBESHINE_KWIN_CAPABILITY_EXEC_START
                    "ExecStart=${VIBESHINE_PRIVILEGED_LIBEXEC_INSTALL_DIR}/vibeshine-kwin-capability prepare")
            set(VIBESHINE_KWIN_CAPABILITY_EXEC_STOP
                    "ExecStop=${VIBESHINE_PRIVILEGED_LIBEXEC_INSTALL_DIR}/vibeshine-kwin-capability restore")
            set(VIBESHINE_KWIN_CAPABILITY_REMAIN_AFTER_EXIT "RemainAfterExit=yes")
        else()
            set(VIBESHINE_KWIN_CAPABILITY_EXEC_START "")
            set(VIBESHINE_KWIN_CAPABILITY_EXEC_STOP "")
            set(VIBESHINE_KWIN_CAPABILITY_REMAIN_AFTER_EXIT "")
        endif()
