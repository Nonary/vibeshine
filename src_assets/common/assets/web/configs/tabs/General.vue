...
<template>
  <div id="general" class="config-page">
    ...
    <!-- Sunshine Name -->
    <div class="mb-3">
      <label for="sunshine_name" class="form-label">{{
        $t("config.sunshine_name")
      }}</label>
      <input
        type="text"
        class="form-control"
    ...
    <!-- Log Level -->
    <div class="mb-3">
      <label for="min_log_level" class="form-label">{{
        $t("config.log_level")
      }}</label>
      <select
        id="min_log_level"
        ...
        <thead>
          <tr>
            ...
            <th scope="col" v-if="platform === 'windows'">
              <font-awesome-icon icon="shield-alt" /> {{ $t("_common.run_as") }}
            </th>
            <th scope="col"></th>
          </tr>
        </thead>
