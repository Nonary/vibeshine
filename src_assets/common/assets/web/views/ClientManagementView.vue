<template>
  <div class="container mx-auto max-w-4xl">
    ...
    <div class="card p-4 mb-6 shadow-sm border border-dark/10 dark:border-light/10 rounded-md bg-white dark:bg-surface">
      ...
      <form class="flex flex-col gap-3 md:flex-row md:items-end" @submit.prevent="registerDevice">
      ...
      <div class="mt-3">
        <div v-if="pairStatus === true" class="alert alert-success">
          {{ $t('pin.pair_success') }}
        </div>
        <div v-if="pairStatus === false" class="alert alert-danger">
          {{ $t('pin.pair_failure') }}
        </div>
      </div>
    ...
    <div class="card p-4 shadow-sm border border-dark/10 dark:border-light/10 rounded-md bg-white dark:bg-surface mb-6">
      ...
      <div v-if="unpairAllStatus === true" class="alert alert-success mb-3">
