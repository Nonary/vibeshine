# Vibeshine requirements traceability
...
| FND-02 | Critical | Dark-first UI with a complete light theme | Theme color tokens, `[data-theme]` | Dark and light preserve the same hierarchy and semantic state meanings; ordinary text, controls, and essential boundaries meet contrast requirements. |
